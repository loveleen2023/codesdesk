...
@Component({
  selector: 'app-gripps-global',
  templateUrl: './gripps-global.component.html',
  styleUrls: ['./gripps-global.component.css']
})
export class GrippsGlobalComponent {
  title = 'Gripps-Global | CodesDesk'
