...
@Component({
  selector: 'app-hoodie-collab',
  templateUrl: './hoodie-collab.component.html',
  styleUrls: ['./hoodie-collab.component.css']
})
export class HoodieCollabComponent {
  title = 'Hoodie-Collab | CodesDesk'
