...
@Component({
  selector: 'app-egyptian-queen',
  templateUrl: './egyptian-queen.component.html',
  styleUrls: ['./egyptian-queen.component.css']
})
export class EgyptianQueenComponent {
  title = 'Egyptian-Queen | CodesDesk'
