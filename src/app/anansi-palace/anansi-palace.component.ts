...
@Component({
  selector: 'app-anansi-palace',
  templateUrl: './anansi-palace.component.html',
  styleUrls: ['./anansi-palace.component.css']
})
export class AnansiPalaceComponent {
  title = 'Anansi-Palace | CodesDesk'
  constructor(
