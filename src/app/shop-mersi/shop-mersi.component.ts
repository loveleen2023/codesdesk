...
@Component({
  selector: 'app-shop-mersi',
  templateUrl: './shop-mersi.component.html',
  styleUrls: ['./shop-mersi.component.css']
})
export class ShopMersiComponent {

  title = 'Shop-mersi | CodesDesk'
