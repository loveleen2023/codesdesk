...
@Component({
  selector: 'app-tanoar-jewelry',
  templateUrl: './tanoar-jewelry.component.html',
  styleUrls: ['./tanoar-jewelry.component.css']
})
export class TanoarJewelryComponent {

  title = 'Tanoar-jewelry | CodesDesk'
